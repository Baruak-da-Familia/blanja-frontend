      ...
      <div className="container">
         ...
         <div className="row">
            ...
            <div className="col-lg-7">
               ...
               <div className="row shadow align-content-center container-select-all">
               ...
               {cart.map(item => {
                  return (
                     <div className="row shadow align-items-center container-items">
                        <div className="col-1 align-self-center">
                           <input type="checkbox" name="items" checked={item.selected} />
                        </div>
                        <div className="col-2">
                        ...
                        <div className="col-2">
                           <div className="row container-counter align-items-center justify-content-between">
                              ...
                              <p>{item.quantity}</p>
                              <button className={classname(colors.white, "btn btn-light btn-quantity")}>+</button>
                           </div>
                        </div>
                        <div className="col-2">
