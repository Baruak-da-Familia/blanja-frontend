...
import { authRegisterCustomerCreator, authRegisterSellerCreator } from '../../redux/actions/auth'
...
const Login = () => {
    ...
    return (
        <div className={classname(styles.body)}>
            {userType === false ? (
                <div>
                    <form className={classname(styles.login)} onSubmit={handleSubmit(onSubmitCustomer)}>
                ...
                <form className={classname(styles.login)} onSubmit={handleSubmit(onSubmitSeller)}>
                    {/* <p className={classname(styles.corpName)}>Blanja</p> */}
                    <img
                        alt='logo'
                        className={classname(styles.logo)}
